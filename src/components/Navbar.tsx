    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <a href="#hero" className="flex items-center gap-3" aria-label="返回 AI Guide 首页顶部">
            <div
          ...
          {/* Desktop Nav */}
          <div className="hidden md:flex items-center gap-6" role="list" aria-label="页面分区导航">
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              ...
              aria-label="在 GitHub 查看 AI Guide 开源仓库"
            >
