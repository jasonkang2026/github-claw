  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        {/* Main heading */}
        <motion.h1 id="hero-title" variants={fadeUp} className="section-heading text-white mb-6" style={{ letterSpacing: "-0.02em" }}>
          程序员鱼皮的
          <br />
        ...
        <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          <a
            ...
            aria-label="立即探索 AI Guide 在线知识库"
          >
            🚀 立即探索知识库
          </a>
          <a
            ...
            aria-label="在 GitHub Star AI Guide 开源项目"
          >
